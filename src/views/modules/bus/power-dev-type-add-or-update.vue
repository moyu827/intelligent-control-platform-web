      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="厂商名称" prop="name">
            <el-input v-model="dataForm.name" placeholder="设备类型名称"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
        ...
        dataFormSubmit () {
          this.$refs['dataForm'].validate((valid) => {
            if (valid) {
              ...
              if (id !== undefined && id !== 0) {
                this.$http({
                  url: this.$http.adornUrl(`/bus/power-dev-type/PUT/powerDevType`),
                  method: 'put',
                ...
                this.$http({
                  url: this.$http.adornUrl(`/bus/power-dev-type/POST/powerDevType`),
                  method: 'post',
                  data: this.$http.adornData({
                    'name': this.dataForm.name
                  })
