<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.name" placeholder="变电站名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
...
<script>
    ...
    import AddOrUpdate from './sub-station-add-or-update'
      ...
      methods: {
        ...
        deleteHandle (id) {
          this.$confirm(`确定删除?`, '提示', {
            ...
            this.$http({
              url: this.$http.adornUrl(`/bus/sub-station/DELETE/subStation`),
              method: 'delete',
