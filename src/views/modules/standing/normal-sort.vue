<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.bzflmc" placeholder="标准分类名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
...
<script>
    ...
    import AddOrUpdate from './normal-sort-add-or-update'
    ...
    export default {
      ...
      methods: {
        formatterGwbz (row, column) {
            // eslint-disable-next-line no-unused-vars
          const rowSfgwbz = row.sfgwbz
          if (rowSfgwbz === 1) {
            return '是'
          } else {
            return '否'
        ...
        deleteHandle (id) {
          this.$confirm(`确定删除?`, '提示', {
            ...
            this.$http({
              url: this.$http.adornUrl(`/standing/normal-sort/DELETE/normalSort`),
              method: 'delete',
