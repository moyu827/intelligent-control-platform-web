<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.mc" placeholder="试验项目名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    export default {
      ...
      methods: {
        ...
        getDataList () {
          ...
          this.$http({
            url: this.$http.adornUrl('/experiment/project/GET/project'),
            method: 'get',
        ...
        deleteHandle (id) {
          this.$confirm(`确定删除?`, '提示', {
            ...
            this.$http({
              url: this.$http.adornUrl(`/experiment/project/DELETE/project`),
              method: 'delete',
